...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1704, 751)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.groupBox = QGroupBox(self.centralwidget)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(0, 140, 1271, 231))
        self.groupBox_7 = QGroupBox(self.groupBox)
        self.groupBox_7.setObjectName(u"groupBox_7")
        self.groupBox_7.setGeometry(QRect(850, 10, 411, 211))
        font = QFont()
        font.setPointSize(8)
        ...
        self.tableView_3.setGeometry(QRect(10, 20, 391, 181))
        self.groupBox_5 = QGroupBox(self.groupBox_2)
        self.groupBox_5.setObjectName(u"groupBox_5")
        self.groupBox_5.setGeometry(QRect(430, 10, 411, 211))
        ...
        self.pushButton_2.setGeometry(QRect(90, 90, 81, 31))
        self.pushButton_3 = QPushButton(self.groupBox_12)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(10, 50, 81, 31))
        self.pushButton_4 = QPushButton(self.groupBox_12)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(90, 20, 81, 31))
        self.pushButton_5 = QPushButton(self.groupBox_12)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(90, 50, 81, 31))
        self.pushButton_9 = QPushButton(self.groupBox_12)
        self.pushButton_9.setObjectName(u"pushButton_9")
        self.pushButton_9.setGeometry(QRect(110, 90, 81, 31))
        self.groupBox_13 = QGroupBox(self.centralwidget)
        self.groupBox_13.setObjectName(u"groupBox_13")
        self.groupBox_13.setGeometry(QRect(0, 0, 1271, 51))
        self.lcdNumber = QLCDNumber(self.centralwidget)
        self.lcdNumber.setObjectName(u"lcdNumber")
        self.lcdNumber.setGeometry(QRect(1280, 10, 331, 31))
        self.lcdNumber.setDigitCount(19)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1704, 33))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("MainWindow", u"PRICE", None))
        self.groupBox_10.setTitle(QCoreApplication.translate("MainWindow", u"PRICE_INFO", None))
        ...
        self.pushButton_10.setText(QCoreApplication.translate("MainWindow", u"TEST1", None))
        ...
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"TEST2", None))
